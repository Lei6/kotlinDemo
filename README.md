...
继承：
-----
Kotlin 中所有类都继承该 Any 类，它是所有类的超类，对于没有超类型声明的类是默认超类<br>
注意：Any 不是 java.lang.Object<br>
如果一个类要被继承，可以使用 open 关键字进行修饰。<br>
~~~
...
* 重写
在基类中，使用fun声明函数时，此函数默认为final修饰，不能被子类重写。如果允许子类重写该函数，那么就要手动添加 open 修饰它, <br>
~~~
/**用户基类**/
open class Person{
